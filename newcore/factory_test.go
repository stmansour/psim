...
func TestMutateInfluencer(t *testing.T) {
	...
	dna := "{Investor;InvW1=0.5000;InvW2=0.5000;Influencers=[{LSMInfluencer,Metric=GCAM_C3_1,Delta1=-65,Delta2=-5}|{LSMInfluencer,Metric=GCAM_C3_1,Delta1=-65,Delta2=-5}}]}"
