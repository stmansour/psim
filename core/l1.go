...
// L1Influencer is the Influencer that predicts based on Linguistic Sentiment associated with a country
type L1Influencer struct {
	cfg                 *util.AppConfig
	Delta1              int
	Delta2              int
	Delta4              int
...
// GetID - get ID string
func (p *L1Influencer) GetID() string {
	return p.ID
}

// SetAppConfig - set cfg
func (p *L1Influencer) SetAppConfig(cfg *util.AppConfig) {
	p.cfg = cfg
}

// GetDelta1 - get Delta1
func (p *L1Influencer) GetDelta1() int {
	return p.Delta1
}

// SetDelta1 - set Delta1
func (p *L1Influencer) SetDelta1(d int) {
	p.Delta1 = d
}

// GetDelta2 - get Delta2
func (p *L1Influencer) GetDelta2() int {
	return p.Delta2
}

// SetDelta2 - set Delta2
func (p *L1Influencer) SetDelta2(d int) {
	p.Delta2 = d
}

// GetDelta4 - get Delta4
func (p *L1Influencer) GetDelta4() int {
	return p.Delta4
}

// SetDelta4 - set Delta4
func (p *L1Influencer) SetDelta4(x int) {
	p.Delta4 = x
}

// SetID - set ID
func (p *L1Influencer) SetID() {
	p.ID = fmt.Sprintf("L1Influencer|%d|%d|%d|%s", p.Delta1, p.Delta2, p.Delta4, util.GenerateRefNo())
}

// Init - initializes a L1Influencer
func (p *L1Influencer) Init(i *Investor, cfg *util.AppConfig, delta4 int) {
	p.myInvestor = i
	p.cfg = cfg
	p.SetID()
	p.Delta4 = delta4
...
func (p *L1Influencer) Subclass() string {
	return "L1Influencer"
}
...
// ----------------------------------------------------------------------------
func (p *L1Influencer) DNA() string {
...
//	t2 = T3-p.Delta2
//
// val1 = L1_C1metric(t1)/L1_C2metric(t1)
// val2 = L1_C1metric(t2)/L1_C2metric(t2)
// delta = val2 - val1
...
//
// ---------------------------------------------------------------------------
func (p *L1Influencer) GetPrediction(t3 time.Time) (string, float64, float64, float64, float64, error) {
...
// ------------------------------------------------------------------------------------
func (p *L1Influencer) CalculateFitnessScore() float64 {
