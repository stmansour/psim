...
// L9Influencer is the Influencer that predicts based on Linguistic Sentiment associated with a country
type L9Influencer struct {
	cfg                 *util.AppConfig
	Delta1              int
	Delta2              int
...
func (p *L9Influencer) GetNilDataCount() int {
	return p.nilDataCount
}

// IncNilDataCount the bit position of the valid data fL9g for this Influencer
func (p *L9Influencer) IncNilDataCount() {
	p.nilDataCount++
}

// GetFlagPos the bit position of the valid data fL9g for this Influencer
func (p *L9Influencer) GetFlagPos() int {
	return p.flagpos
}

// GetFitnessScore returns the current value of Fitness
func (p *L9Influencer) GetFitnessScore() float64 {
	return p.Fitness
}

// SetFitnessScore sets this objects FitnessScore to the supplied value
func (p *L9Influencer) SetFitnessScore(x float64) {
	p.Fitness = x
...
// GetID - get ID string
func (p *L9Influencer) GetID() string {
	return p.ID
}

// SetAppConfig - set cfg
func (p *L9Influencer) SetAppConfig(cfg *util.AppConfig) {
	p.cfg = cfg
}

// GetDelta1 - get Delta1
func (p *L9Influencer) GetDelta1() int {
	return p.Delta1
}

// SetDelta1 - set Delta1
func (p *L9Influencer) SetDelta1(d int) {
	p.Delta1 = d
}

// GetDelta2 - get Delta2
func (p *L9Influencer) GetDelta2() int {
	return p.Delta2
}

// SetDelta2 - set Delta2
func (p *L9Influencer) SetDelta2(d int) {
	p.Delta2 = d
}

// SetID - set ID
func (p *L9Influencer) SetID() {
	p.ID = fmt.Sprintf("L9Influencer|%d|%d|%s", p.Delta1, p.Delta2, util.GenerateRefNo())
}

// Init - initializes a L9Influencer
func (p *L9Influencer) Init(i *Investor, cfg *util.AppConfig, delta4 int) {
	p.myInvestor = i
	p.cfg = cfg
	p.SetID()
	// p.flagpos = 5
...
func (p *L9Influencer) Subclass() string {
	return "L9Influencer"
}
...
// ----------------------------------------------------------------------------
func (p *L9Influencer) DNA() string {
...
//	vaL9       - an indicator value at T3 - p.Delta2 days
...
//
// ---------------------------------------------------------------------------
func (p *L9Influencer) GetPrediction(t3 time.Time) (string, float64, float64, float64, float64, error) {
...
// CalculateFitnessScore - See expL9nation in common.go calculateFitnessScore
//
// RETURNS - the fitness score
// ------------------------------------------------------------------------------------
func (p *L9Influencer) CalculateFitnessScore() float64 {
