...
// L7Influencer is the Influencer that predicts based on Linguistic Sentiment associated with a country
type L7Influencer struct {
	cfg                 *util.AppConfig
	Delta1              int
	Delta2              int
...
func (p *L7Influencer) GetNilDataCount() int {
	return p.nilDataCount
}

// IncNilDataCount the bit position of the valid data fL7g for this Influencer
func (p *L7Influencer) IncNilDataCount() {
	p.nilDataCount++
}

// GetFlagPos the bit position of the valid data fL7g for this Influencer
func (p *L7Influencer) GetFlagPos() int {
	return p.flagpos
}

// GetFitnessScore returns the current value of Fitness
func (p *L7Influencer) GetFitnessScore() float64 {
	return p.Fitness
}

// SetFitnessScore sets this objects FitnessScore to the supplied value
func (p *L7Influencer) SetFitnessScore(x float64) {
	p.Fitness = x
...
// GetID - get ID string
func (p *L7Influencer) GetID() string {
	return p.ID
}

// SetAppConfig - set cfg
func (p *L7Influencer) SetAppConfig(cfg *util.AppConfig) {
	p.cfg = cfg
}

// GetDelta1 - get Delta1
func (p *L7Influencer) GetDelta1() int {
	return p.Delta1
}

// SetDelta1 - set Delta1
func (p *L7Influencer) SetDelta1(d int) {
	p.Delta1 = d
}

// GetDelta2 - get Delta2
func (p *L7Influencer) GetDelta2() int {
	return p.Delta2
}

// SetDelta2 - set Delta2
func (p *L7Influencer) SetDelta2(d int) {
	p.Delta2 = d
}

// SetID - set ID
func (p *L7Influencer) SetID() {
	p.ID = fmt.Sprintf("L7Influencer|%d|%d|%s", p.Delta1, p.Delta2, util.GenerateRefNo())
}

// Init - initializes a L7Influencer
func (p *L7Influencer) Init(i *Investor, cfg *util.AppConfig, delta4 int) {
	p.myInvestor = i
	p.cfg = cfg
	p.SetID()
	// p.flagpos = 5
...
func (p *L7Influencer) Subclass() string {
	return "L7Influencer"
}
...
// ----------------------------------------------------------------------------
func (p *L7Influencer) DNA() string {
...
//	vaL7       - an indicator value at T3 - p.Delta2 days
...
//
// ---------------------------------------------------------------------------
func (p *L7Influencer) GetPrediction(t3 time.Time) (string, float64, float64, float64, float64, error) {
...
// CalculateFitnessScore - See expL7nation in common.go calculateFitnessScore
//
// RETURNS - the fitness score
// ------------------------------------------------------------------------------------
func (p *L7Influencer) CalculateFitnessScore() float64 {
